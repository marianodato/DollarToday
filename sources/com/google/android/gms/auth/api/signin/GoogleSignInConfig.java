...
public class GoogleSignInConfig implements Optional, SafeParcelable {
    ...
    public static final class zza {
        ...
        public GoogleSignInConfig zzmc() {
            return new GoogleSignInConfig((Set) this.zzTm, this.zzQd, this.zzTi, this.zzTj, this.zzTk, this.zzTl);
        }
    }

    GoogleSignInConfig(int versionCode2, ArrayList<Scope> scopes, Account account, boolean idTokenRequested, boolean serverAuthCodeRequested, boolean forceCodeForRefreshToken, String serverClientId) {
