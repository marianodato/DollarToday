...
public interface zzjq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzjq {
        ...
        private static class C0536zza implements zzjq {
            private IBinder zznJ;

            C0536zza(IBinder iBinder) {
                this.zznJ = iBinder;
            }
        ...
        public static zzjq zzah(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzjq)) ? new C0536zza(iBinder) : (zzjq) queryLocalInterface;
        }
