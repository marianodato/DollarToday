...
public interface zzkj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkj {
        ...
        private static class C0540zza implements zzkj {
            private IBinder zznJ;

            C0540zza(IBinder iBinder) {
                this.zznJ = iBinder;
            }
        ...
        public static zzkj zzav(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkj)) ? new C0540zza(iBinder) : (zzkj) queryLocalInterface;
        }
