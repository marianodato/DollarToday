...
public interface zzkd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkd {
        ...
        private static class C0538zza implements zzkd {
            private IBinder zznJ;

            C0538zza(IBinder iBinder) {
                this.zznJ = iBinder;
            }
        ...
        public static zzkd zzao(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkd)) ? new C0538zza(iBinder) : (zzkd) queryLocalInterface;
        }
