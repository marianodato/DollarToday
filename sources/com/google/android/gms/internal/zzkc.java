...
public interface zzkc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkc {
        ...
        private static class C0537zza implements zzkc {
            private IBinder zznJ;

            C0537zza(IBinder iBinder) {
                this.zznJ = iBinder;
            }
        ...
        public static zzkc zzan(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkc)) ? new C0537zza(iBinder) : (zzkc) queryLocalInterface;
        }
