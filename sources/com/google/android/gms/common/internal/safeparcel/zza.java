...
public class zza {
    ...
    public static class C0524zza extends RuntimeException {
        public C0524zza(String str, Parcel parcel) {
    ...
    private static void zza(Parcel parcel, int i, int i2) {
        int zza = zza(parcel, i);
        if (zza != i2) {
            throw new C0524zza("Expected size " + i2 + " got " + zza + " (0x" + Integer.toHexString(zza) + ")", parcel);
        }
    }

    private static void zza(Parcel parcel, int i, int i2, int i3) {
        if (i2 != i3) {
            throw new C0524zza("Expected size " + i3 + " got " + i2 + " (0x" + Integer.toHexString(i2) + ")", parcel);
        }
    }
    ...
    public static int zzap(Parcel parcel) {
        ...
        int dataPosition = parcel.dataPosition();
        if (zzbM(zzao) != 20293) {
            throw new C0524zza("Expected object header. Got 0x" + Integer.toHexString(zzao), parcel);
        }
        int i = dataPosition + zza;
        if (i >= dataPosition && i <= parcel.dataSize()) {
            return i;
        }
        throw new C0524zza("Size read is invalid start=" + dataPosition + " end=" + i, parcel);
    }
