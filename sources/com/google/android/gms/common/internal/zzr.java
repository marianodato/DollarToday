...
public interface zzr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzr {
        ...
        private static class C0527zza implements zzr {
            private IBinder zznJ;

            C0527zza(IBinder iBinder) {
                this.zznJ = iBinder;
            }
        ...
        public static zzr zzaJ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzr)) ? new C0527zza(iBinder) : (zzr) queryLocalInterface;
        }
