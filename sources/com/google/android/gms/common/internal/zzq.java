...
public interface zzq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzq {
        ...
        private static class C0526zza implements zzq {
            private IBinder zznJ;

            C0526zza(IBinder iBinder) {
                this.zznJ = iBinder;
            }
        ...
        public static zzq zzaI(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzq)) ? new C0526zza(iBinder) : (zzq) queryLocalInterface;
        }
