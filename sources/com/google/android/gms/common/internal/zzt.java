...
public interface zzt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzt {
        ...
        private static class C0529zza implements zzt {
            private IBinder zznJ;

            C0529zza(IBinder iBinder) {
                this.zznJ = iBinder;
            }
        ...
        public static zzt zzaL(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzt)) ? new C0529zza(iBinder) : (zzt) queryLocalInterface;
        }
