...
public final class ViewPropertyAnimatorCompat {
    ...
    static class BaseViewPropertyAnimatorCompatImpl implements ViewPropertyAnimatorCompatImpl {
        ...
        /* renamed from: x */
        public void mo2577x(ViewPropertyAnimatorCompat vpa, View view, float value) {
            postStartMessage(vpa, view);
        }
        ...
        /* renamed from: y */
        public void mo2579y(ViewPropertyAnimatorCompat vpa, View view, float value) {
            postStartMessage(vpa, view);
        }
        ...
        /* renamed from: z */
        public void mo2581z(ViewPropertyAnimatorCompat vpa, View view, float value) {
        }
    ...
    interface ViewPropertyAnimatorCompatImpl {
        ...
        /* renamed from: x */
        void mo2577x(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        void xBy(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        /* renamed from: y */
        void mo2579y(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        void yBy(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        /* renamed from: z */
        void mo2581z(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat mo2540x(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo2577x(this, view, value);
        }
        return this;
    }
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat mo2542y(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo2579y(this, view, value);
        }
        return this;
    }
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat mo2544z(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo2581z(this, view, value);
        }
        return this;
    }
