...
class AppCompatTextHelper {
    private static final int[] TEXT_APPEARANCE_ATTRS = {C0188R.attr.textAllCaps};
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        if (!(this.mView.getTransformationMethod() instanceof PasswordTransformationMethod)) {
            ...
            if (ap != -1) {
                TypedArray appearance = context.obtainStyledAttributes(ap, C0188R.styleable.TextAppearance);
                if (appearance.hasValue(C0188R.styleable.TextAppearance_textAllCaps)) {
                    allCaps = appearance.getBoolean(C0188R.styleable.TextAppearance_textAllCaps, false);
                }
                appearance.recycle();
            }
